...
export const metadata: Metadata = {
  title: { absolute: "Athira Technology | AI-Assisted SDLC" },
  description: "Explore Athira Technology's planned AI-assisted components for software planning, development, testing, and deployment.",
};

export default function Home() {
  const features = [
    {
      icon: <Code aria-hidden="true" className="w-6 h-6" />,
    ...
    },
    {
      ...
      desc: "The product direction emphasizes careful handling of code and project context; specific controls and certifications are still being defined."
    },
    {
      icon: <Zap aria-hidden="true" className="w-6 h-6" />,
      title: "Lightning Fast CI/CD",
      desc: "The planned workflow is designed to support CI/CD automation; supported platforms and deployment controls are still being validated."
    }
  ];

  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4 text-center relative">
      <div aria-hidden="true" className="absolute inset-0 bg-[radial-gradient(circle_at_50%_40%,rgba(59,130,246,0.1),transparent_70%)] pointer-events-none"></div>
      ...
      <StaggerContainer className="max-w-4xl space-y-8 mt-24 relative z-10" staggerChildren={0.1}>
        ...
        <StaggerItem>
          <p className="text-lg text-slate-400 max-w-xl mx-auto">
            Athira is exploring AI-assisted components for planning, development, testing, and deployment across the software lifecycle.
          </p>
        </StaggerItem>
        ...
        <StaggerItem>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 pt-4">
            <ButtonLink href="/contact" size="lg" className="w-full sm:w-auto">
              Get Started <ArrowRight aria-hidden="true" className="ml-2 w-4 h-4" />
            </ButtonLink>
            <ButtonLink href="/ai-software-engineer" variant="outline" size="lg" className="w-full sm:w-auto">
          ...
          <StaggerItem key={i} className="h-full">
            <Card className="h-full group hover:border-blue-500/50 transition-colors">
              <CardHeader>
                ...
                <CardTitle as="h2">{feature.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <p>{feature.desc}</p>
              </CardContent>
