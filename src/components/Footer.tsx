        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/ai-engineer" className="hover:text-blue-400 transition-colors">AI Engineer</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/agents" className="hover:text-blue-400 transition-colors">All Agents</Link></li>
              <li><Link to="/agent/planning" className="hover:text-blue-400 transition-colors">Planning</Link></li>
              <li><Link to="/agent/development" className="hover:text-blue-400 transition-colors">Development</Link></li>
            </ul>
          </div>
          <div>
